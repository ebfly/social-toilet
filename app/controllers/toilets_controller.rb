class ToiletsController < ApplicationController
  ...
  private
  def toilet_params
    params.require(:toilet).permit(:name, :prefecture_id, :category_id, :condition_id, :number_id, :multi_id, :text, :address, 
                                   :latitude, :longitude, images: []).merge(user_id: current_user.id)
  end
